...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-B7WZ6K5G.js").then(function(n4) {
...
function _upload(client, httpRequest, assetType, body, opts = {}) {
  ...
  const config2 = client.config(), options = optionsFromFile(opts, body), { tag, label, title, description, creditLine, filename, source } = options, isMediaLibrary = config2.resource?.type === "media-library", query = isMediaLibrary ? {
...
var eventSourcePolyfill = defer(() => import("./browser-GZE4W654.js")).pipe(
