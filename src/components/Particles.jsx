...
const fragment = /* glsl */ `
  ...
  void main() {
    ...
    float circle = smoothstep(0.5, 0.35, d) * 0.6;
    gl_FragColor = vec4(vColor + 0.1 * sin(uv.yxx + uTime + vRandom.y * 6.28), circle);
  }
`;
...
export default function Particles({
  ...
  particleSpread = 10,
  speed = 0.03,
  particleColors = ['#333333', '#444444', '#555555', '#222222'],
  ...
  }, [particleCount, particleSpread, speed, moveParticlesOnHover, particleHoverFactor, particleBaseSize, sizeRandomness, cameraDistance, particleColors]);
